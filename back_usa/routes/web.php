...
Route::get('/verificar-paso-vocacional', [EstudianteController::class, 'verificar_paso_vocacional']);
Route::post('/guardar-respuesta-vocacional', [EstudianteController::class, 'guardar_respuesta_vocacional']);