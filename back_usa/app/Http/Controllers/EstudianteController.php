...
class EstudianteController extends Controller
{
    ...
    public function verificar_paso_vocacional(){

        $data = request()->all();

        $vocacional = DB::connection("mysql")
        ->table("vocacional_respuestas")
        ->where("id_estudiante", $data["id"])
        ->select("*")
        ->first();
        ...
        if($vocacional == null){
            ...
            if($vocacional->bloque_1 == 0 && $vocacional->bloque_2 == 0 && $vocacional->bloque_3 == 0 && $vocacional->bloque_4 == 0 && $vocacional->bloque_5 == 0){
                return response()->json([
                    'paso' => 1,
                ]);
            }

            if($vocacional->bloque_1 == 1 && $vocacional->bloque_2 == 0 && $vocacional->bloque_3 == 0 && $vocacional->bloque_4 == 0 && $vocacional->bloque_5 == 0){
                return response()->json([
                    'paso' => 2,
                ]);
            }

            if($vocacional->bloque_1 == 1 && $vocacional->bloque_2 == 1 && $vocacional->bloque_3 == 0 && $vocacional->bloque_4 == 0 && $vocacional->bloque_5 == 0){
                return response()->json([
                    'paso' => 3,
                ]);
            }

            if($vocacional->bloque_1 == 1 && $vocacional->bloque_2 == 1 && $vocacional->bloque_3 == 1 && $vocacional->bloque_4 == 0 && $vocacional->bloque_5 == 0){
                return response()->json([
                    'paso' => 4,
                ]);
            }

            if($vocacional->bloque_1 == 1 && $vocacional->bloque_2 == 1 && $vocacional->bloque_3 == 1 && $vocacional->bloque_4 == 1 && $vocacional->bloque_5 == 0){
                return response()->json([
                    'paso' => 5,
                ]);
            }
            ...
            if($vocacional->bloque_1 == 1 && $vocacional->bloque_2 == 1 && $vocacional->bloque_3 == 1 && $vocacional->bloque_4 == 1 && $vocacional->bloque_5 == 1 && $vocacional->estado_calificado == 0){
                return response()->json([
                    'paso' => 6,
                ]);
            }

            if($vocacional->bloque_1 == 1 && $vocacional->bloque_2 == 1 && $vocacional->bloque_3 == 1 && $vocacional->bloque_4 == 1 && $vocacional->bloque_5 == 1 && $vocacional->estado_calificado == 1){
                return response()->json([
                    'paso' => 7,
                ]);
            }
